...
Contributions are welcome. This is an open-source framework — the more perspectives and expertise it includes, the better it serves healthcare organizations.

## What We're Looking For

- **New exercises** — Practical, healthcare-relevant exercises for any competency level
- **Industry variants** — Adaptations for specific healthcare roles (nursing, pharmacy, radiology, etc.)
...
- **Tool guides** — How-tos for specific AI tools in healthcare contexts
- **Translations** — Making the framework accessible in other languages

## Guidelines

1. **No PHI or sensitive data.** All examples must use hypothetical or publicly available information.
...
2. Create a feature branch (`git checkout -b add-radiology-exercises`)
3. Make your changes
