---
layout: default
title: "Capstone: Personal AI Playbook"
---
...
1. **Prompt library** — Tested, categorized, with usage notes
2. **Workflow recipes** — Multi-step processes for recurring tasks
3. **Lessons learned** — What works, what doesn't, and why
4. **Teaching materials** — At least one walkthrough you've shared with others
